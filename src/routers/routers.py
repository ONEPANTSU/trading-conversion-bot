...
from src.routers.admin_routers.editor_settings_router import EditorSettingsRouter
...
from src.routers.editor_routers.private_post_sending_router import PrivatePostSendingRouter
...
class Routers:
    ...
    def __init__(self, services: Services):
        self.command_router = CommandRouter(
            services.admin_service, services.editor_service, services.user_service
        )
